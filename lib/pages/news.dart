...
class _NewsPageState extends State<NewsPage> {
  ...
  List<NewsCall> _getFilteredNews() {
  ...
  Widget _buildNewsCard(NewsCall news) {
                ...
                onPressed: () async {
                  if (headlineController.text.isEmpty ||
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                          content: Text('Please fill in headline and content')),
                    );
                    return;
                  }
                  ...
                  final maxId = allNews.isEmpty
                      ? 0
                      : allNews.map((n) => n.id ?? 0).reduce((a, b) =>
                  a > b
                      ? a
                      : b);

                  final newNews = NewsCall(
                    id: maxId + 1,
...
*/
  // ==================== READ (Details View) ====================
  void _showNewsDetails(NewsCall news) {
                          ...
                          children: [
                            Row(
                              children: [
                                CircleAvatar(
                                  child: Text(
                                      news.displayAuthor[0].toUpperCase()),
                                  radius: 20,
                                ),
                                SizedBox(width: 12),
                                Expanded(
                            ...
                            Row(
                              children: [
                                Icon(Icons.fingerprint, size: 20, color: Colors
                                    .grey[700]),
                                SizedBox(width: 8),
                                Text(
                                  'Article ID: ${news.id}',
                        ...
                        children: [
                          ...
                          Expanded(
                            child: OutlinedButton.icon(
                              ...
                              label: Text(
                                  'Delete', style: TextStyle(color: Colors
                                  .red)),
...
/*
  // ==================== UPDATE ====================
  void _showEditNewsDialog(NewsCall news) {
  ...
  // ==================== DELETE ====================
  void _showDeleteConfirmation(NewsCall news) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Row(
